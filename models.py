...
class CloseApproach:
    ...
    def __init__(self, designation, time, distance, velocity, **info):
        ...
        :param velocity: The velocity, in kilometers per second,
    ...
    def __str__(self):
        """Return `str(self)`."""
        # Use this object's attributes to return a human-readable string representation.
        fullname = self.neo.fullname if self.neo else self._designation
        return (
            f"On {self.time_str}, '{fullname}' approaches Earth "
